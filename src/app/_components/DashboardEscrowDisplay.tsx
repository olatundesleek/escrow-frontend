  ...
  return (
    <div className="w-full grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-6 m-7">
      <UserDetailCard
        ...
        value={completed || 0}
        cardColor="bg-green-100 border-1 border-green-200"
      ...
      <UserDetailCard
        ...
        value={active || 0}
        cardColor="bg-blue-100 border-1 border-blue-200"
      ...
      <UserDetailCard
        ...
        value={pending || 0}
        cardColor="bg-orange-100 border-1 border-orange-200"
      ...
      <UserDetailCard
        ...
        value={disputed || 0}
        cardColor="bg-red-100 border-1 border-red-200"
