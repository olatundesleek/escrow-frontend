...
// //       <div className=" bg-white overflow-hidden  rounded-lg shadow-md border-2  border-black w-full  lg:w-[50%]">
// //         <table className="min-w-full overflow-hidden text-md">
...
//         Latest Transactions
//       </h2>
//       <div className="bg-white h-full flex flex-col overflow-hidden border-2 border-black rounded-lg shadow-md">
//         <div className="flex-1 overflow-hidden">
//           <table className="min-w-full text-sm">
//             <thead className="bg-gray-200 text-gray-600 ">
//               <tr>
//                 <th className="p-3 text-left">User</th>
//                 <th className="p-3 text-left">TRX</th>
