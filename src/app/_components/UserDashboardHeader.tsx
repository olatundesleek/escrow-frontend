...
export default function UserDashboardHeader({
  ...
  return (
    <header className="w-full border-b border-db-border flex justify-between items-center px-5 py-1 h-header-height min-h-header-height max-h-header-height fixed lg:relative bg-db-surface z-100">
